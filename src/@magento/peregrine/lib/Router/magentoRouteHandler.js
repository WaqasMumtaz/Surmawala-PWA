...
export default class MagentoRouteHandler extends Component {
    ...
    componentDidMount() {
        ...
        //console.log('path name rootcomponent >>', pathname)
        const isSearch = pathname === '/search.html';
        //console.log('path equal >>', isSearch)
    ...
    componentDidUpdate() {
        ...
        const isSearch = pathname === '/search.html';
        //console.log('componentDidUpdate Method pathname >>', isSearch)
    ...
    async getRouteComponent() {
        ...
        console.log('getRouteComponent apiBase >>>', apiBase)
